...
<div class="container">
    ...
    <header>
        <div class="search-container">
            <input type="text" name="search" class="search-box" placeholder="Rechercher un utilisateur...">
...
<div class="modal" id="userModal">
    <div class="modal-content">
        <div class="modal-header">
            <h2><span class="material-icons-sharp" id="modalIcon">person_add</span> <span id="modalTitle">Ajouter un
                    utilisateur</span></h2>
        </div>
